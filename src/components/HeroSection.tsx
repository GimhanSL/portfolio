  ...
  return (
    <section id="home" className="relative flex items-center justify-center min-h-[calc(100vh-56px)] py-20 px-4">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
        <div className="md:col-span-2 flex justify-center md:justify-start items-center gap-8">
          <div className="relative">
            <h1 className="text-5xl md:text-6xl font-bold font-headline text-primary [writing-mode:vertical-rl] transform rotate-180 whitespace-nowrap">
              Gimhan Sajee Kumara
            </h1>
          </div>
